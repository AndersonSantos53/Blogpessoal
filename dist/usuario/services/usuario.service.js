...
const bcypt_1 = require("../../auth/bcrypt/bcypt");
...
let UsuarioService = class UsuarioService {
    ...
    async create(usuario) {
        ...
        throw new common_1.HttpException("O Usuario ja existe!", common_1.HttpStatus.BAD_REQUEST);
    }
    async update(usuario) {
        ...
        if (buscaUsuario && buscaUsuario.id !== usuario.id)
            throw new common_1.HttpException('Usuário (e-mail) já Cadastrado!', common_1.HttpStatus.BAD_REQUEST);
        usuario.senha = await this.bcrypt.criptografarSenha(usuario.senha);
        return await this.usuarioRepository.save(usuario);
    }
};
